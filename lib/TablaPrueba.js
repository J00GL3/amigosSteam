            ...
            <tr key={rowIndex}>
              {
                  ...
                  <td key={cellIndex} style={(cell.amistad && cell.totalComunes > 0) ? {backgroundColor:"#16abff33"}:{backgroundColor: ""}}>
                    ...
                    <p style={{display:"flex",alignItems: "center", justifyContent: "center", cursor: "pointer"}} onClick={() => enviarData([cell.jugadora, cell.jugadorb, cell.arrayComunes, cell.arrayComunes_other])}>{cell.totalComunes}</p>
