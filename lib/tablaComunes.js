...
export default function TablaComunes(props) {
    ...
    //                     personaname: b.data.personaname,
    //                     personastate: b.data.personastate,
    //                     realname: b.data.realname,
    //                     timecreated: b.data.timecreated,
    //                     antiguedad: Math.floor((Date.now() - new Date(b.data.timecreated*1000))/(1000*60*60*24*365)),
    //                     comunityvisibility: b.data.communityvisibilitystate,
    //                     estado: () => {
    //                         switch(b.data.personastate){
    //                             case 0:
    //                                 return "Offline";
    //                             case 1:
    //                                 return "En linea";
    ...
    //                     },
    //                     privacidad: () => {
    //                         switch(b.data.communityvisibilitystate){
    //                             case 1:
    ...
    //                         }
    //                     },
    //                     profileurl: b.data.profileurl,
    //                     friend_since: b.data.since,
    //                     days_since: () => Math.floor((Date.now() - new Date(b.data.since*1000))/(1000*60*60*24))
    //                 }
    //             );
